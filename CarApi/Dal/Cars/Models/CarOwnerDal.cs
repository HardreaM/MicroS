...
public record CarOwnerDal : BaseEntityDal<Guid>
{
    ...
    [Column("surname")] public required string Surname { get; init; }

    [Column("login")] public required string Login { get; init; }

    [Column("email")] public required string Email { get; init; }

    [Column("phone")] public required string Phone { get; init; }
